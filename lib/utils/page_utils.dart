...
abstract final class PageUtils {
  ...
  static Future<void>? toVideoPage({
    ...
    final Map<String, dynamic> arguments = {
      ...
      'title': title,
      'progress': progress,
      if (progress != null) 'progressAid': aid ?? IdUtils.bv2av(bvid!),
      if (progress != null) 'progressBvid': bvid ?? IdUtils.av2bv(aid!),
      if (progress != null) 'progressCid': cid,
      'videoType': videoType,
