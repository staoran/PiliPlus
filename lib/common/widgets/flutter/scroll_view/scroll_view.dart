...
/// See also:
///
///  * [ExtendedListView], which is a commonly used [ScrollView] that displays a
///    scrolling, linear list of child widgets.
///  * [PageView], which is a scrolling list of child widgets that are each the
///    size of the viewport.
///  * [ExtendedGridView], which is a [ScrollView] that displays a scrolling, 2D array
///    of child widgets.
...
typedef customScrollView = ExtendedCustomScrollView;
...
/// them.
///
/// There are four options for constructing a [ExtendedListView]:
///
...
// ignore: camel_case_types
typedef listView = ExtendedListView;
...
class ExtendedListView extends BoxScrollView {
  ...
  ///
  /// {@tool dartpad}
  /// This example shows a [ExtendedListView] that uses a custom [SliverChildBuilderDelegate] to support child
  /// reordering.
  ///
...
/// [ExtendedListView] and [ExtendedGridView].
...
// ignore: camel_case_types
typedef gridView = ExtendedGridView;
