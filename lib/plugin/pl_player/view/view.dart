...
class _PLVideoPlayerState extends State<PLVideoPlayer>
  ...
  void _onHorizontalDragStart() {
    plPlayerController.onSeekStart(plPlayerController.position);
  }

  void _onHorizontalDragUpdate(double dx) {
    final curPos =
        plPlayerController.seekToPos?.inMilliseconds ??
        plPlayerController.seekPosition.value.inMilliseconds;
    ...
    final position = Duration(milliseconds: newPos);
    plPlayerController
      ..seekToPos = position
                    ...
                    children: [
                      Obx(
                        () => ProgressBar(
                          ...
                          buffered: plPlayerController.bufferedSeconds.value,
                          total: plPlayerController.duration.value.inSeconds,
                    ...
                    children: [
                      ...
                      if (plPlayerController.isBuffering.value)
                        Obx(() {
                          ...
                          return Text(
                            DurationUtils.formatDuration(buffered.inSeconds),
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 12,
                            ),
